# Package Development Stage: @kb-labs/cli-api
...
- **API Operations**: < 100ms for cached operations ✅
- **Plugin Discovery**: < 1s for typical workspace ✅
- **Memory Usage**: Low ✅
...
- **Production Instances**: REST API, Studio
- **Issues**: None
